...
def self.header_for(doc,tutor)
  ...
  doc.indent(0.125.in){
    ...
    doc.move_down( 0.125.in )
   doc.text "At the completion of the program, your check will come from Mantua Public Schools"
  }
end
...
According to our records, you (#{tutor.first_name} #{tutor.last_name}) will be receiving your check at the end of the program from Mantua Public Schools.
